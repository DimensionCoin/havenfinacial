...
const Landing = () => {
  return (
    <main className="min-h-[100svh] bg-black text-white relative">
      {/* Fixed background stays pinned, no margin */}
      ...
      {/* Everything below gets pushed down in PWA */}
        ...
        <section className="container mx-auto max-w-6xl px-6 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="mt-6 text-lg text-white/80 leading-relaxed">
              Haven combines the security of traditional banking with the power
              of decentralized finance. Maximize your savings potential while
        ...
        <section className="container mx-auto max-w-6xl px-6 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Experience the future of banking with traditional security and
              DeFi innovation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-white/70">
                Earn up to 8% APY on your savings through carefully selected
                DeFi protocols
              </p>
            </div>
